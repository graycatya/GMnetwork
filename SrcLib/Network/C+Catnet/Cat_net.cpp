...
int CATNET::CatNet::Socket(int family, int sockettype, int protocol)
{
	int sock;
...
int CATNET::CatNet::Bind(int fd, struct sockaddr *addr, void* addrlen)
{
	#ifdef _WINDOWSSYS_
...
int CATNET::CatNet::Listen(int fd, int backlog)
{
	int ret;
...
int CATNET::CatNet::Accept(int fd, struct sockaddr *addr, void *addrlen, int connects)
{
	#ifdef _WINDOWSSYS_
	int* addlen = (int*)addrlen;
	#else
...
int CATNET::CatNet::Connect(int fd, const struct sockaddr *addr, void* addrlen)
{
	#ifdef _WINDOWSSYS_
	int* addlen = (int*)addrlen;
	#else
...
int CATNET::CatNet::Close(int fd)
{
	int ret;
	#ifdef _WINDOWSSYS_
...
ssize_t CATNET::CatNet::Read(int fd, void *buf, size_t len)
{
	#ifdef _WINDOWSSYS_
		char* bufs = (char*)buf;
	#else
...
ssize_t CATNET::CatNet::Send(int fd, const void *buf, size_t len)
{
	#ifdef _WINDOWSSYS_
...
ssize_t CATNET::CatNet::Reads(int fd, void *buf, size_t len)
{
...
ssize_t CATNET::CatNet::Sends(int fd, const void *buf, size_t len)
{
...
ssize_t CATNET::CatNet::Read(int fd, void *buf, size_t len, struct sockaddr* src_addr, void* addrlen)
{
	#ifdef _WINDOWSSYS_
	int* addlen = (int*)addrlen;
	#else
...
ssize_t CATNET::CatNet::Send(int fd, const void *buf, size_t len, const struct sockaddr* dest_addr, void* addrlen)
{
	#ifdef _WINDOWSSYS_
	int* addlen = (int*)addrlen;
	#else
...
ssize_t CATNET::CatNet::Reads(int fd, void *buf, size_t len, struct sockaddr* src_addr, void* addrlen)
{
	#ifdef _WINDOWSSYS_
	int* addlen = (int*)addrlen;
	#else
...
ssize_t CATNET::CatNet::Sends(int fd, const void *buf, size_t len, const struct sockaddr* dest_addr, void* addrlen)
{
	#ifdef _WINDOWSSYS_
	int* addlen = (int*)addrlen;
	#else
...
int CATNET::CatNet::TcpScoket(const char* IP, short Port, int Ip_family)
{
	#ifdef _WINDOWSSYS_
		//初始化WSA
		...
		case CAT_IPV4:
			{
				...
				Bind(fd, (struct sockaddr *)&server_addr, (void *)&addlen);
				break;
			}
		case CAT_IPV6:
			{
...
int CATNET::CatNet::UdpScoket(const char* IP, short Port, int Ip_family)
{
	#ifdef _WINDOWSSYS_
		//初始化WSA
		WORD sockVersion = MAKEWORD(2, 2);
